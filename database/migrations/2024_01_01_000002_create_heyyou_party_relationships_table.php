...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create(TablePrefixer::prefix('party_relationships'), function (Blueprint $table) {
            ...
            $table->foreignUuid('from_party_id')->constrained(TablePrefixer::prefix('parties'))->cascadeOnDelete();
            $table->foreignUuid('to_party_id')->constrained(TablePrefixer::prefix('parties'))->cascadeOnDelete();
