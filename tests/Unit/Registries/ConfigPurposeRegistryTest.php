...
it('implements PurposeRegistry interface', function (): void {
    $registry = new ConfigPurposeRegistry;

    expect($registry)->toBeInstanceOf(PurposeRegistry::class);
});

it('checks if purpose exists', function (): void {
    $registry = new ConfigPurposeRegistry;
...
it('gets a purpose by slug', function (): void {
    $registry = new ConfigPurposeRegistry;
...
it('throws exception for nonexistent purpose', function (): void {
    $registry = new ConfigPurposeRegistry;

    $registry->get('nonexistent');
})->throws(InvalidArgumentException::class);

it('returns all purposes', function (): void {
    $registry = new ConfigPurposeRegistry;
...
it('returns parent slug', function (): void {
    $registry = new ConfigPurposeRegistry;
...
it('throws exception for parent of nonexistent purpose', function (): void {
    $registry = new ConfigPurposeRegistry;

    $registry->parent('nonexistent');
})->throws(InvalidArgumentException::class);

it('returns children of a purpose', function (): void {
    $registry = new ConfigPurposeRegistry;
...
it('returns empty collection for purposes with no children', function (): void {
    $registry = new ConfigPurposeRegistry;
